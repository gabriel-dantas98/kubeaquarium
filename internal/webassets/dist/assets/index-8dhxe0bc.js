...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function Kc(){return new pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Bo(),fragmentShader:`
		...
		`,blending:Gn,depthTest:!1,depthWrite:!1})}function jc(){return new pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Bo(),fragmentShader:`
...
`)}function o_(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:s.getAttribLocation(e,a),locationSize:o}}return t}function fs(s){return s!==""}function al(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ol(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const c_=/^[ \t]*#include +<([\w\d./]+)>/gm;function fo(s){return s.replace(c_,h_)}const l_=new Map;function h_(s,e){let t=ke[e];if(t===void 0){const n=l_.get(e);if(n!==void 0)t=ke[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return fo(t)}const u_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function cl(s){return s.replace(u_,d_)}function d_(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function ll(s){let e=`precision ${s.precision} float;
...
`].filter(fs).join(`
`)),a=fo(a),a=al(a,t),a=ol(a,t),o=fo(o),o=al(o,t),o=ol(o,t),a=cl(a),o=cl(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
[stream error: ${o}]`)}}appendLogChunk(e){const t=document.getElementById("d-logs");this.logsBuf+=e,this.logsBuf.length>256*1024?(this.logsBuf=this.logsBuf.slice(this.logsBuf.length-200*1024),t.textContent=this.logsBuf):t.append(e),this.autoscroll&&(t.scrollTop=t.scrollHeight)}}function zn(s,e){const t=document.getElementById(s);t&&(t.textContent=e)}function Sv(s){const e=s.reason;return e==="CrashLoopBackOff"||e==="Error"||e==="ImagePullBackOff"||e==="ErrImagePull"?"err":s.phase==="Running"&&s.ready?"ok":s.phase==="Pending"?"warn":s.phase==="Failed"?"err":s.phase==="Succeeded"?"ok":""}function ei(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}const Ev=50;function _r(s){return s.toLowerCase().trim()}function Tv(s){return _r(s).split(/\s+/).filter(Boolean)}function bv(s,e){if(e.length===0)return 1;let t=0;const n=_r(s.name),i=_r(s.namespace??""),r=_r(s.kind);for(const a of e){let o=0;for(const c of s.tokens)c===a?o=Math.max(o,100):c.startsWith(a)?o=Math.max(o,50):c.includes(a)&&(o=Math.max(o,20));if(o===0)return null;t+=o}for(const a of e)n===a?t+=80:n.startsWith(a)&&(t+=35),i===a&&(t+=24),r===a&&(t+=12);return t}function wv(s,e){const t=Tv(e),n=[];for(const i of s){const r=bv(i,t);r!==null&&n.push({item:i,score:r})}return n.sort((i,r)=>{if(r.score!==i.score)return r.score-i.score;const a=(i.item.namespace??"").localeCompare(r.item.namespace??"");return a!==0?a:i.item.name.localeCompare(r.item.name)}),n.slice(0,Ev).map(i=>i.item)}function Av(s){const e=s;return!!e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)}function ls(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function Rv(s){let e=2166136261;for(let t=0;t<s.length;t++)e^=s.charCodeAt(t),e=Math.imul(e,16777619);return e>>>0}class Cv{constructor(e){this.handlers=e,window.addEventListener("keydown",t=>this.onGlobalKey(t)),this.input.addEventListener("input",()=>{this.query=this.input.value,this.activeIndex=0,this.render()}),this.input.addEventListener("keydown",t=>this.onInputKey(t))}handlers;root=document.getElementById("radar");input=document.getElementById("radar-input");results=document.getElementById("radar-results");count=document.getElementById("radar-count");scope=document.getElementById("radar-scope");empty=document.getElementById("radar-empty");isOpen=!1;query="";activeIndex=0;visibleItems=[];open(){this.isOpen=!0,this.query="",this.activeIndex=0,this.input.value="",this.root.classList.remove("hidden"),this.render(),this.input.focus()}close(){this.isOpen=!1,this.root.classList.add("hidden"),this.input.blur()}toggle(){this.isOpen?this.close():this.open()}render(){const e=this.handlers.getItems();this.visibleItems=wv(e,this.query),this.activeIndex>=this.visibleItems.length&&(this.activeIndex=Math.max(0,this.visibleItems.length-1)),this.count.textContent=`${this.visibleItems.length} / ${e.length}`,this.renderResults(),this.renderScope()}renderResults(){const e=this.visibleItems.length>0;if(this.empty.classList.toggle("hidden",e),!e){this.results.innerHTML="";return}this.results.innerHTML=this.visibleItems.map((t,n)=>{const i=n===this.activeIndex?" active":"",r=t.status?`<span class="radar-status">${ls(t.status)}</span>`:"",a=t.meta?`<span>${ls(t.meta)}</span>`:"",o=t.namespace?`<span>${ls(t.namespace)}</span>`:"";return`
      ...
      ${e}
    `}move(e){if(this.visibleItems.length===0)return;const t=this.activeIndex+e;this.activeIndex=(t+this.visibleItems.length)%this.visibleItems.length,this.renderResults(),this.renderScope()}selectActive(){const e=this.visibleItems[this.activeIndex];e&&(this.handlers.onSelect(e),this.close())}onGlobalKey(e){(e.metaKey||e.ctrlKey)&&e.key.toLowerCase()==="k"&&(!this.isOpen&&Av(e.target)||(e.preventDefault(),this.toggle()))}onInputKey(e){e.key==="Escape"?(e.preventDefault(),this.close()):e.key==="ArrowDown"?(e.preventDefault(),this.move(1)):e.key==="ArrowUp"?(e.preventDefault(),this.move(-1)):e.key==="Enter"&&(e.preventDefault(),this.selectActive())}}const Pv=14,Lv=60,lr=4;class Iv{root=document.getElementById("labels");pool=[];inUse=[];render(e){const t=[...e].sort((c,l)=>c.focused!==l.focused?c.focused?-1:1:c.matched!==l.matched?c.matched?-1:1:c.screen.depth-l.screen.depth);let n=Pv;e.some(c=>c.matched)&&(n=Math.min(Lv,t.filter(c=>c.matched).length+4));const i=t.slice(0,n),r=[...this.root.querySelectorAll(".pod-label")];for(;r.length<i.length;){const c=document.createElement("div");c.className="pod-label",this.root.appendChild(c),r.push(c)}for(const c of r)hs(c);this.inUse.length=0;const a=r;this.pool=[];const o=[];for(const c of i){const l=a.pop();if(!l)break;const h=c.screen.x,u=c.screen.y-c.screen.offsetY;l.style.left=h+"px",l.style.top=u+"px",l.innerHTML=`<span class="ns">${Cl(c.namespace)}</span><span class="status">${Cl(c.status)}</span>`,l.title=`${c.namespace}/${c.name}`,l.classList.remove("visible","focused","match","ok","warn","err","info"),l.classList.add(c.statusClass),c.focused&&l.classList.add("focused"),c.matched&&l.classList.add("match");const d=Dv(l,h,u);if(!c.focused&&o.some(p=>Uv(p,d))){hs(l),this.pool.push(l);continue}o.push(d),this.inUse.push(l),l.classList.add("visible")}for(const c of a)hs(c),this.pool.push(c)}hideAll(){for(const e of this.inUse)hs(e),this.pool.push(e);this.inUse.length=0,this.pool=[...new Set(this.pool)];for(const e of this.pool)hs(e)}}function Dv(s,e,t){const n=s.offsetWidth,i=s.offsetHeight;return{left:e-n/2-lr,right:e+n/2+lr,top:t-i-lr,bottom:t+lr}}function Uv(s,e){return s.left<e.right&&s.right>e.left&&s.top<e.bottom&&s.bottom>e.top}function hs(s){s.classList.remove("visible","focused","match"),s.style.left="",s.style.top="",s.title=""}function Cl(s){return s.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}const Nv=document.getElementById("scene"),He=new iv(Nv),nn=new yv,Fv=new Iv,Ov=document.getElementById("attack-frame"),vr=document.getElementById("attack-toggle"),ct=new hv,_o=new J0({onChange:(s,e)=>Bv(s,e),onSubmit:()=>{const s=He.firstMatchUid();if(s){const e=ct.pods.get(s);e&&(He.focusOnPod(s),He.setFocused(s),nn.show(e))}}});new Cv({getItems:zv,onSelect:Hv});let Eh=Ir,Th="",ai=new Map,xr=[],vo=!1,li=!1,ko=null;function Bv(s,e){Eh=s,Th=e,He.setFilter(s,e.trim().length>0,ct.pods),_o.setCount(He.countMatched(),ct.pods.size,e.trim().length>0)}function kv(s){const e=s.reason||s.phase;return{id:s.uid,kind:"pod",name:s.name,namespace:s.namespace,status:e,meta:s.node,tokens:["pod",s.name,s.namespace,e,s.phase,s.reason,s.node].filter(Boolean).map(t=>t.toLowerCase())}}function zv(){return[...ct.pods.values()].map(kv)}function Hv(s){if(s.kind!=="pod")return;const e=ct.pods.get(s.id);e&&(He.focusOnPod(s.id),He.setFocused(s.id),nn.show(e))}function Vv(s){const e=s;return!!e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)}function Gv(s){return!!s?.closest('button,input,select,textarea,a,[role="button"],[role="listbox"],.detail,.radar,.search')}function bh(s){li=s,He.setAttackMode(s),document.body.classList.toggle("attack",s),Ov.classList.toggle("hidden",!s),vr.classList.toggle("active",s),vr.setAttribute("aria-pressed",String(s)),vr.title=s?"Disarm attack mode":"Arm attack mode"}const Sa=document.getElementById("kill-feed"),Wv=5,Pl=4e3;function Ll(s,e){const t=document.createElement("div");t.className="kill-entry";const n=document.createElement("span");n.textContent="🚀";const i=document.createElement("span");i.className="kill-target",i.textContent=`${s}/${e}`;const r=document.createElement("span");for(r.className="kill-verb",r.textContent="eliminated",t.append(n,i,r),Sa.prepend(t);Sa.children.length>Wv;)Sa.lastElementChild.remove();window.setTimeout(()=>t.classList.add("leaving"),Pl-500),window.setTimeout(()=>t.remove(),Pl)}async function Xv(s){if(!li)return;const e=ct.pods.get(s);if(!e)return;const{namespace:t,name:n}=e;if(ri){ct.apply({type:"deleted",uid:s}),He.removePod(s),document.getElementById("pod-count").textContent=`${ct.pods.size} pods`,Ll(t,n);return}const i=`/api/pod/${encodeURIComponent(t)}/${encodeURIComponent(n)}`,r=await fetch(i,{method:"DELETE"});if(!r.ok){console.warn("[kubeaquarium] missile delete failed",t,n,await r.text()),He.clearTargeted(s);return}Ll(t,n)}const wh=new(ri?dv:lv)(s=>{xr.push(s),Kv()});wh.onConnectionChange=s=>{document.getElementById("ws-dot")?.classList.toggle("live",s),Rh=s,Ch()};document.getElementById("ws-dot").classList.remove("live");He.onSelect=s=>{const e=ct.pods.get(s);e&&(He.setFocused(s),nn.show(e))};He.onAttackHit=s=>{ko=s,Xv(s)};vr.addEventListener("click",()=>bh(!li));const qv=nn.hide.bind(nn);nn.hide=()=>{qv(),He.setFocused(null)};window.addEventListener("keydown",s=>{if((s.metaKey||s.ctrlKey)&&s.key.toLowerCase()==="l"&&!Vv(s.target)){s.preventDefault(),bh(!li);return}s.key==="Escape"&&(document.getElementById("detail")?.classList.contains("hidden")||nn.hide())});He.start();wh.start();function Ah(){Fv.render(He.getLabelTargets()),requestAnimationFrame(Ah)}requestAnimationFrame(Ah);const Yv=ri?Promise.resolve(fv()):fetch("/api/contexts").then(s=>s.json());Yv.then(s=>{const e=s.find(t=>t.current);document.getElementById("ctx-name").textContent=e?e.name:s[0]?.name??"—"});function Kv(){vo||(vo=!0,requestAnimationFrame(jv))}function jv(){if(vo=!1,xr.length===0)return;const s=xr;xr=[];const e=new Set;let t=!1,n=!1;for(const r of s){if(r.type==="snapshot"){ct.apply(r),ai=$v(ct.pods.values()),t=!0,n=!0,e.clear();continue}if(r.type==="deleted"){const o=ct.pods.get(r.uid);ct.apply(r),o&&(Dl(o.namespace),n=!0),e.delete(r.uid),He.removePod(r.uid),nn.isOpenFor(r.uid)&&(nn.hide(),He.setFocused(null));continue}const a=ct.pods.get(r.pod.uid);ct.apply(r),a?a.namespace!==r.pod.namespace&&(Dl(a.namespace),Il(r.pod.namespace),n=!0):(Il(r.pod.namespace),n=!0),e.add(r.pod.uid),nn.isOpenFor(r.pod.uid)&&nn.show(r.pod)}n&&He.rebuildNamespaceBubbles(ai);const i=new Map;if(t)for(const r of ct.pods.values())He.upsertPod(r,i);else for(const r of e){const a=ct.pods.get(r);a&&He.upsertPod(a,i)}document.getElementById("pod-count").textContent=`${ct.pods.size} pods`,Th.trim().length>0?(He.setFilter(Eh,!0,ct.pods),_o.setCount(He.countMatched(),ct.pods.size,!0)):_o.setCount(0,ct.pods.size,!1),Ch()}function $v(s){const e=new Map;for(const t of s)e.set(t.namespace,(e.get(t.namespace)??0)+1);return e}function Il(s){ai.set(s,(ai.get(s)??0)+1)}function Dl(s){const e=(ai.get(s)??0)-1;e>0?ai.set(s,e):ai.delete(s)}let Rh=!1;function Ch(){const s=document.getElementById("empty-state"),e=document.getElementById("empty-msg");if(ct.pods.size>0){s.classList.add("hidden"),s.style.display="none";return}s.style.display="",s.classList.remove("hidden"),e.textContent=Rh?"No pods to show in this context. Once workloads are created they will swim in.":"Connecting to your cluster…"}const Ph=document.createElement("div");Ph.className="crosshair";document.body.appendChild(Ph);function zo(s,e){const t=Math.max(24,Math.min(window.innerWidth-24,s)),n=Math.max(52,Math.min(window.innerHeight-56,e));document.body.style.setProperty("--aim-x",`${t}px`),document.body.style.setProperty("--aim-y",`${n}px`),He.setAimClientPoint(t,n)}zo(window.innerWidth/2,window.innerHeight/2);window.addEventListener("pointermove",s=>{He.isDiving&&zo(s.clientX,s.clientY)});window.addEventListener("pointerdown",s=>{s.button!==0||!li||!He.isDiving||Gv(s.target)||(zo(s.clientX,s.clientY),s.preventDefault(),s.stopPropagation(),He.fireAttack())},!0);window.__kubeaquarium={get fps(){return Math.round(He.fpsAvg)},get pods(){return ct.pods.size},get matched(){return He.countMatched()},get attackMode(){return li},get diveMode(){return He.isDiving},get projectiles(){return He.projectileCount},get lastAttackHitUid(){return ko},submarineDebug(){return He.getSubmarineDebug()},slotsDebug(){return He.getSlotsDebug()},pause(){He.paused=!0},resume(){He.paused=!1}};window.render_game_to_text=()=>JSON.stringify({mode:He.isDiving?"dive":"orbit",attackMode:li,pods:ct.pods.size,fps:Math.round(He.fpsAvg),projectiles:He.projectileCount,lastAttackHitUid:ko,aim:{x:getComputedStyle(document.body).getPropertyValue("--aim-x").trim()||"50vw",y:getComputedStyle(document.body).getPropertyValue("--aim-y").trim()||"50vh"}});console.log("[kubeaquarium] ready");
