...
export type MissionState='find'|'inspect'|'fire'|'observe'|'complete';
export class DemoMission {
 state:MissionState='find';private root?:HTMLElement;private closed=false;
